...
7. **Present** — Deliver the validated result to the user. Optionally note: *"Generated by local Qwen model, validated by Claude."*
...
> *Drafted by local Qwen model (coder-model), reviewed and validated by Claude.*
