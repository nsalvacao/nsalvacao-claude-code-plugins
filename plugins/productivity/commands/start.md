...
Open the dashboard using the platform-appropriate command:
- **macOS:** `open dashboard.html`
- **Linux:** `xdg-open dashboard.html`
- **Windows/WSL:** `powershell.exe -c "start dashboard.html"` or `wslview dashboard.html`

If the open command fails, tell the user: "Dashboard is ready at `dashboard.html`. Open it from your file browser to get started."
