...
If **your project tracker** (Linear, Jira, Asana, etc.) via MCP is connected:
...
If **your chat tool** (Slack, Teams, etc.) via MCP is connected:
...
If **your meeting notes tool** (Fireflies, Gong, etc.) via MCP is connected:
- Pull recent meeting notes and discussion summaries
- Find decisions and action items from relevant meetings

If **your knowledge base** (Notion, Confluence, etc.) via MCP is connected:
...
- If **your chat tool** (Slack, Teams, etc.) via MCP is connected, offer to draft the message for sending
