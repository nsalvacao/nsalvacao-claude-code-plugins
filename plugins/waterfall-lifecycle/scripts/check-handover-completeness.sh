...
usage() {
  ...
  echo ""
  echo "Validate Gate C handover completeness — all 12 Gate C mandatory artefacts present,"
  ...
  echo "  - All 12 Gate C mandatory artefacts present"
...
check_artefact "operational-design-package.md"
check_artefact "security-design-review.md"
check_artefact "assumption-register.md"
